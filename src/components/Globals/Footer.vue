  ...
  <div class="py-4 container mx-auto">
    <div class="flex flex-row justify-center items-center py-10">
      <a
        ...
        target="_blank"
        rel="nofollow"
        class="icon-circle icon-circle--reddit mx-4 hover:bg-black"
      >
      ...
      <a
        ...
        target="_blank"
        rel="nofollow"
        class="icon-circle icon-circle--twitter mx-4 hover:bg-black"
      >
      ...
      <a
        ...
        class="icon-circle icon-circle--email mx-4 hover:bg-black"
      >
      ...
      <a
        ...
        target="_blank"
        rel="nofollow"
        class="icon-circle icon-circle--instagram mx-4 hover:bg-black"
      >
